...
In Figure \ref{fig:topic_comp} we present the topic composition of all projects in the active mission field ranked by decreasing importance in the chronic disease-related group. The second panel presents the year when each project was funded in the vertical axis, the level of funding it received in the size of the marker, and the funder in its colour. Perhaps unsurprisingly
